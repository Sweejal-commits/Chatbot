intents_responses={
       "greetings":{
           "patterns":["hello","hii"],
            "responses": ["Hello! How can i assist you with your college related queries?"]
            },
        "courses":{
           "patterns":["Can you tell me about the courses","What courses are provided"],
             "responses":["The college offers BBA, BCA, BA, Psc. See details is the college website. "],
       },
...
def get_response(intent_name):
    ...
    return intents_responses.get(intent_name,{}).get("responses",["sorry, I don't understand."])[0]